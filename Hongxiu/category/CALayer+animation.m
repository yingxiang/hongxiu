...
- (Block_void)completeHandle {
    return objc_getAssociatedObject(self, completionBlockKey);
}

- (void)setCompleteHandle:(Block_void)completeHandle{
 ...
 *  @return 转场动画实例
 */
- (void)animationWithType:(animType)animType subType:(animSubType)subType curve:(animCurve)curve duration:(CGFloat)duration repeatsCount:(NSInteger)repeats completion:(Block_void)complete{
 ...
 */
- (void)opacityTimes_Animation:(NSInteger)repeatTimes durTimes:(float)time completion:(Block_void)complete
{
 ...
 *  @return animation obj
 */
- (void)rotation:(float)dur degree:(float)degree direction:(WAxis)axis repeatCount:(NSInteger)repeatCount completion:(Block_void)complete
{
 ...
 */
- (void)scaleFrom:(CGFloat)fromScale toScale:(CGFloat)toScale durTimes:(float)time rep:(NSInteger)repeatTimes completion:(Block_void)complete
{
 ...
 */
- (void)shake_AnimationRepeatTimes:(NSInteger)repeatTimes durTimes:(float)time completion:(Block_void)complete
{
